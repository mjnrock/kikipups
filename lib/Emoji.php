<?php
    ...
    abstract class Emoji {
        ...
        static function constructor() {
            ...
            foreach($temp as $Emoji) {
                Emoji::$EmojiList[ $Emoji->name ] = $Emoji;
            }
        }

        static function HTML($name) {
            return Emoji::$EmojiList[ $name ]->html;
        }

        static function __callStatic($method, $args) {
            return Emoji::HTML($method);

            // if(preg_match("^([a-z0-9_]{1,})$", $method)) {
            //     return Emoji::HTML($method);
            // } else if(preg_match("^([A-Z0-9_]{4,})$", $method)) {
            //     return Emoji::HTML($method);
            // }            
        }
    }
